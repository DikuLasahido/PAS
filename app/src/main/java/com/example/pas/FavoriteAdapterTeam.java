...
public class FavoriteAdapterTeam extends RecyclerView.Adapter<FavoriteAdapterTeam.MyViewHolder> {
    private List<ModelTeamRealm> dataList;
    ...
    public FavoriteAdapterTeam(List<ModelTeamRealm> dataList, Callback callback) {
    ...
    @NonNull
    @Override
    public FavoriteAdapterTeam.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.activity_adapter_team, parent, false);
